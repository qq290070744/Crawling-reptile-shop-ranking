    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i>饿了么店铺排名</h2>
                <div class="box-icon">
 ...
 <div id="wepaydailysales" class="box-content" style="width:100%;">
 	<form id="grid_form_id">
 		<table class="table table-striped table-bordered bootstrap-datatable datatable responsive">		
			...
			<th class="th4"  style="width:25%;"> 地址</th>
...
<?php            
    ...
    $queryString = "SELECT store_name,paiming,dingwei_address,updatetime FROM dbo.elm_paiming ORDER BY paiming aSC";
